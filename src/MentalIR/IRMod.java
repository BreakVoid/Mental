...
public class IRMod extends IRBinaryArithmetic {
    ...
    public IRMod(IRData lhs, IRData rhs, IRData res) {
        super(lhs, rhs, res);
    }
    ...
    public String toMips(MIPSMachine mipsMachine) {
        ...
        if (this.rhs instanceof IRWordLiteral) {
            ...
            mipsInstructions.add(
                    String.format("\trem %s, %s, %d", this.res.toRegister(), lhsRegister, ((IRWordLiteral) this.rhs).context)
            );
            ...
            mipsInstructions.add(
                    String.format("\trem %s, %s, %s", this.res.toRegister(), lhsRegister, rhsRegister)
            );
