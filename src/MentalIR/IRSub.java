...
public class IRSub extends IRBinaryArithmetic {
    ...
    public String toMips(MIPSMachine mipsMachine) {
        ...
        if (this.rhs instanceof IRWordLiteral) {
            ...
            mipsInstructions.add(
                    String.format("\tsub %s, %s, %d", this.res.toRegister(), lhsRegister, ((IRWordLiteral) this.rhs).context)
            );
            ...
            mipsInstructions.add(
                    String.format("\tsub %s, %s, %s", this.res.toRegister(), lhsRegister, rhsRegister)
            );
