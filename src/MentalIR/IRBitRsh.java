...
public class IRBitRsh extends IRBinaryArithmetic {
    ...
    public String toMips(MIPSMachine mipsMachine) {
        ...
        if (this.rhs instanceof IRWordLiteral) {
            ...
            mipsInstructions.add(
                    String.format("\tsra %s, %s, %d", this.res.toRegister(), lhsRegister, ((IRWordLiteral) this.rhs).context)
            );
            ...
            mipsInstructions.add(
                    String.format("\tsra %s, %s, %s", this.res.toRegister(), lhsRegister, rhsRegister)
            );
            this.res.produce();
        }
