...
public class IRMul extends IRBinaryArithmetic {
    ...
    public String toMips(MIPSMachine mipsMachine) {
        ...
        if (this.rhs instanceof IRWordLiteral) {
            ...
            mipsInstructions.add(
                    String.format("\tmul %s, %s, %d", this.res.toRegister(), lhsRegister, ((IRWordLiteral) this.rhs).context)
            );
            ...
            mipsInstructions.add(
                    String.format("\tmul %s, %s, %s", this.res.toRegister(), lhsRegister, rhsRegister)
            );
            this.res.produce();
        }
